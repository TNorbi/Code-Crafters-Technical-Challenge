namespace OneTimePassWebApp.API.Utils
{
    ...
    {
        public static readonly string GET_ALL_USERS_SUCCESS_MESSAGE = "All users were successfully send";
        public static readonly string GET_USER_BY_USERID_SUCCES_MESSAGE = "User with given userID was successfully found";
        ...
        public static readonly string VERIFY_OTP_SUCCES_MESSAGE = "Correct OTP was given";
    }
}
